...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `crud` (`id`, `firstname`, `lastname`, `gender`, `status`, `date`, `reason`)
    VALUES (NULL, '$firstname', '$lastname', '$gender', '$status', '$date', '$reason')";
...
<body>
    ...
    <div class="container mt-5 justify-content-center align-items-center">
        <h2 class="text-center mb-4">Create Attendance</h2>
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="absent" value="A">
                            ...
                            <div class="col-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="permission" value="P">
                            ...
                            <div class="col-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="present" value="✓">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="" name="reason" rows="4"></textarea>
                    </div>
